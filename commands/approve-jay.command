...
if ! gh pr comment "$PR_NUMBER" --body "✅ PM-APPROVED"; then
  echo "❌ approve 코멘트 등록 실패 (PR #$PR_NUMBER) — 위 gh 에러 메시지 확인."
  read -n 1; exit 1
fi
echo "✅ approve 완료 (PR #$PR_NUMBER) — merge-jay.command로 머지하세요."
